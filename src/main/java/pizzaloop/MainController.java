...
public class MainController {
    ...
    */
    ...
    public @ResponseBody Iterable<UserDetails> getUserDetails() {return userRepository.findAll(); }

    @GetMapping(path="/orderall")
    public @ResponseBody Iterable<OrderDetails> getOrderDetails() {return orderRepository.findAll(); }

    @GetMapping(path="/paymentall")
    public @ResponseBody Iterable<PaymentDetails> getPaymentDetails() {return paymentRepository.findAll(); }
    ...
    */
    ...
    public @ResponseBody String addNewUser(@RequestParam Integer userId, @RequestParam String name, @RequestParam String password) {
    ...
    public @ResponseBody String addNewOrder(@RequestParam Integer pizzaId, @RequestParam Integer orderId, @RequestParam String name,@RequestParam String address,@RequestParam String contactNo) {
        OrderDetails orderDetails = new OrderDetails();
        orderDetails.setPizzaId(pizzaId);
        orderDetails.setOrderId(orderId);
        orderDetails.setName(name);
        orderDetails.setAddress(address);
        orderDetails.setContactNo(contactNo);
        orderRepository.save(orderDetails);
        return SUCCESS;
    }

    @GetMapping(path="/addPayment")
    public @ResponseBody String addNewPayment(@RequestParam Integer paymentId, @RequestParam String cardNo, @RequestParam String pinNo,@RequestParam Date dateOfexp) {
